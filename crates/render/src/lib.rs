//! infinite-chat-render — wgpu 渲染后端(M8 scene / M9 effects / M10 render)。
//!
//! 输入 core 的 [`FrameData`](infinite_chat_core::FrameData)(语义字形),输出像素。
...
pub use scene::{glyph_key, GpuInstance, PanelInstance, RectInstance, WidgetInstance};
