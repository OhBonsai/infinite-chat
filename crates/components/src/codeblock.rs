...
pub fn clamp_scroll_y(scroll_y: i32, n_lines: usize) -> i32 {
...
pub fn clamp_scroll_x(scroll_x: f32, max_line_w: f32, code_view_w: f32) -> f32 {
...
pub fn edge_fade(y_in_view: f32, view_h: f32, line_h: f32, scroll_y: i32, max_scroll: i32) -> f32 {
...
pub fn culled(y_in_view: f32, view_h: f32) -> bool {
...
pub fn gutter_width(n_lines: usize, char_w: f32, pad: f32) -> f32 {
