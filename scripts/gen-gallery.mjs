...
<body>
<nav style="display:flex;gap:24px;align-items:center;padding:14px 24px;border-bottom:1px solid #463714;font-family:'Cinzel',serif;text-transform:uppercase;letter-spacing:.14em;font-size:13px;background:#0a0e14">
  <a href="./" style="margin-right:auto;color:#c8aa6e;font-weight:700;letter-spacing:.1em;text-decoration:none">INFINITE-CHAT</a>
  <a href="./" style="color:#a09b8c;text-decoration:none">首页</a>
  <a href="./chat/" style="color:#a09b8c;text-decoration:none">对话</a>
  <a href="./markdown/" style="color:#a09b8c;text-decoration:none">Markdown</a>
  <a href="./components/" style="color:#a09b8c;text-decoration:none">组件</a>
  <a href="./gallery.html" aria-current="page" style="color:#f0e6d2;text-decoration:none">画廊</a>
  <a href="https://github.com/OhBonsai/infinite-chat" target="_blank" rel="noopener" style="color:#a09b8c;text-decoration:none">GitHub</a>
</nav>
<div class="wrap">
  <h1><b>opencode</b> · shaderbox icon gallery</h1>
  <p class="sub">纯片元 SDF 程序化图标,任意缩放锐利。青 #3DF5D0 / 靛 #1A1040。</p>
